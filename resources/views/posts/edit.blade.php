...
@include("partials.header")
    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="mt-8">
            ...
            <form action="{{ route('post.update', ['post'=>$post->id] ) }}" method="POST"   class="space-y-5 mt-5">
                @csrf
                ...
                <button type="submit" class="text-center w-full bg-blue-900 rounded-md text-white py-3 font-medium">Редактирование</button>
            </form>
